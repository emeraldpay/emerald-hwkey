...
| *Description*                                     | *Length (byte)*
| struct size (BE)                                  | 2
| link:ledger-ethereum-tlv.adoc#enum_value[ENUM_VALUE struct] | variable
|====================================================================
...
| *Description*                                                 | *Length (byte)*
| struct size (BE)                                              | 2
| link:ledger-ethereum-tlv.adoc#transaction_info[TRANSACTION_INFO struct] | variable
|================================================================================
...
| *Description*                           | *Length (byte)*
| struct size (BE)                        | 2
| link:ledger-ethereum-tlv.adoc#field[FIELD struct] | variable
|===========================================================
...
| *Description*                                     | *Length (byte)*
| struct size (BE)                                  | 2
| link:ledger-ethereum-tlv.adoc#proxy_info[PROXY_INFO struct] | variable
|====================================================================
...
| struct size (BE)                                  | 2
| link:ledger-ethereum-tlv.adoc#auth_7702[AUTH_7702 struct]   | variable
|====================================================================
